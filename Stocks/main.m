...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        SetupPurchase(firstPurchase, 2.0, 4.50, 40);
        SetupPurchase(secondPurchase, 2.30, 4.50, 40);
        SetupPurchase(thirdPurchase, 2.30, 4.50, 40);
        
        Portfolio *portfolio = [[Portfolio alloc] init];
        [portfolio addHoldinObject: firstPurchase];
        [portfolio addHoldinObject:secondPurchase];
        [portfolio addHoldinObject:thirdPurchase];
        
        NSLog(@"%.1f", [portfolio costPorfolio]);
